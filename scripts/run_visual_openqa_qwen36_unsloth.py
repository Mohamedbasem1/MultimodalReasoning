...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        action="store_true",
        default=True,
        help="Resume from existing output/raw files and skip completed question IDs.",
    )
    parser.add_argument(
        "--no-resume",
        dest="resume",
        action="store_false",
        help="Start from scratch and overwrite existing output/raw files.",
    )
...
def load_existing_predictions(
    ...
    for row in read_json_rows(output_path):
        ...
        predictions.append({"question_id": question_id, answer_field: answer})
