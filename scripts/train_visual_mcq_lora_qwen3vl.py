...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="LoRA/QLoRA fine-tune Qwen3-VL-8B-Thinking on labeled Visual MCQ data."
    )
    ...
    parser.add_argument("--output-dir", default="outputs/qwen3vl8b-thinking-examsv-lora")
    ...
    parser.add_argument(
        ...
        help="Model dtype. Use bfloat16 on L40S/A100/H100/RTX Pro 6000 Blackwell.",
    )
    parser.add_argument(
        "--attn-implementation",
        default=None,
...
def load_model(args: argparse.Namespace) -> Qwen3VLForConditionalGeneration:
    kwargs: Dict[str, Any] = {
