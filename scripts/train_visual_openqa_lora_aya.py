...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="LoRA/QLoRA fine-tune Aya Vision 8B on Visual OpenQA.")
    ...
    parser.add_argument("--output-dir", default="outputs/aya-vision-8b-openqa-lora")
    ...
    parser.add_argument("--eval-steps", type=int, default=0, help="Set >0 to enable generation eval during training.")
