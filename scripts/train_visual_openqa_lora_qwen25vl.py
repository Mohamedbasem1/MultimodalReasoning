...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="LoRA/QLoRA fine-tune Qwen2.5-VL-7B-Instruct on Visual OpenQA.")
    ...
    parser.add_argument("--output-dir", default="outputs/qwen25vl7b-instruct-openqa-lora")
